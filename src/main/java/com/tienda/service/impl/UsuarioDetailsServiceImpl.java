...
public class UsuarioDetailsServiceImpl implements UsuarioDetailsService, UserDetailsService {
    ...
    @Autowired
    private HttpSession session; /* Se puede almacenar datos de la sesion del usuario que esta logueado y se guarde para ser usado en otros lados o consultado*/
